      ...
      <main className="mx-auto grid max-w-[460px] gap-6 px-4 py-6">
        <section>
          ...
          <p className="mt-3 text-sm leading-6 text-ink-600">
            Game logistics, RSVP visibility, result placeholders, film links, and family instructions in one place.
          </p>
        </section>
        ...
        <Card>
          ...
          <CardContent className="grid gap-3">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-lg border border-ink-200 p-3">
                <p className="flex items-center gap-2 text-sm font-bold text-ink-950">
                  <Trophy size={15} className="text-falcon-700" />
                  Score
                </p>
                <p className="mt-2 text-sm text-ink-600">{platformGameDay.score} | {platformGameDay.result}</p>
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>RSVP and attendance</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            ...
            <p className="text-sm leading-6 text-ink-600">
              Family status: <span className="font-bold text-ink-950">{gameRsvp.familyStatus}</span>
            </p>
            <Link href="/messages">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Film and highlights</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
